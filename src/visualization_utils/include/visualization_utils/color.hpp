...
public:
    ...
    static const Color Green() { return Color(0.0, 0.7, 0.0); } // Kino traj color 
    static const Color Blue() { return Color(0.0, 0.0, 1.0); } // bspline traj
    static const Color SteelBlue() { return Color(0.4, 0.7, 1.0); } // Astar path
