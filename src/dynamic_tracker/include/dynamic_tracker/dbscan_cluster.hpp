...
*/
    ...
    private:
        ...
        void core(unsigned int minPoints, std::vector<float>& eps_list, pcl::PointCloud<pcl::PointXYZI>::Ptr input_cloud, std::vector<int> &clusterIds);
    ...
    public:
        ...
        void run(pcl::PointCloud<pcl::PointXYZI>::Ptr pointcloud,std::vector<int> &clusterIds,bool adaptive);
